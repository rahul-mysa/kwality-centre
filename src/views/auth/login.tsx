    ...
    <div class="card bg-base-100 shadow-xl w-full max-w-sm">
      <div class="card-body items-center text-center">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h1 class="text-2xl font-bold">Kwality Centre</h1>
        </div>
        <p class="text-base-content/60 text-sm mb-6">Test management, simplified.</p>

        <a href="/auth/google" class="btn btn-outline btn-wide gap-3">
